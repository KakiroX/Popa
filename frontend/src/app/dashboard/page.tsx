            ...
            <Card className="glass border-none overflow-hidden group">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
                  Explore universities across the globe with our interactive map tool.
                </p>
                <Link href="/university-map">
              ...
              <Card className="glass border-none border-dashed border-border bg-transparent">
                <CardContent className="flex flex-col items-center justify-center py-12 text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground max-sm mx-auto mt-1">
