...
- **AI:** Google Gemini API (`gemini-1.5-flash` model) via `google-genai` Python SDK for squad challenge generation
...
**Model:** `gemini-1.5-flash` via the `google-genai` Python SDK.
